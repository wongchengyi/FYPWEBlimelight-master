...
class miniBadgesPage extends StatelessWidget {
  const miniBadgesPage({Key? key}) : super(key: key);
  @override
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                Image(
                                  ...
                                  width: 75,
                                  image:
                                      AssetImage('assets/images/minibadge.png'),
                                ),
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: <Widget>[
                                    buildText1(fontTheme, "Mini Badges"),
                                    Padding(
                                        padding:
                                            EdgeInsets.fromLTRB(0, 0, 0, 25)),
                                    Text("Mini Badges show..."),
