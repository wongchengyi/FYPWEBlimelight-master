...
class postsTabPage extends StatefulWidget {
  const postsTabPage({Key? key}) : super(key: key);

  @override
  _postsTabPageState createState() => _postsTabPageState();
}
...
class _postsTabPageState extends State<postsTabPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      child: Column(
        children: [posts(context)],
      ),
    );
  }
}

//main post tab to include all of the other white container
